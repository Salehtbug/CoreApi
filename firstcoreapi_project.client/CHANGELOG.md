...
- Create Angular project with ng: `ng new firstcoreapi_project.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`firstcoreapi_project.client.esproj`).
